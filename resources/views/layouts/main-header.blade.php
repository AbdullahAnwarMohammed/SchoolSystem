<!--=================================
header start-->
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="background: #282a39;color:white">
    <!-- logo -->
    <div class="text-left navbar-brand-wrapper">
        @if (App::getLocale() == 'ar')
        <h4 class="text-white">مدرستي</h4>
        @else 
        <h4 class="text-center"><i class="fas fa-school"></i> SYSTEM SCHOOL </h4>
        @endif
